...
**⌃⌘Tab** does the same from any app without opening the menu at all. The
chord needs no Accessibility grant; if another app already owns it, the menu
item simply stops advertising it.
